""" This is a small program to demonstrate the use
    of the SMLButton class, which is used
    in this project """
...
from tkinter_custom_button import SMLButton
...
class App(tkinter.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.button_1 = SMLButton(master=self,
                                  bg_color=None,
                                  fg_color="#2874A6",
                                  hover_color="#5499C7",
                                  text_font=None,
        ...
        self.button_2 = SMLButton(master=self,
                                  bg_color=None,
                                  fg_color="#922B21",
                                  border_color="white",
                                  hover_color="#CD6155",
        ...
        self.button_3 = SMLButton(master=self,
                                  bg_color=None,
                                  fg_color="#1E8449",
                                  hover_color="#2ECC71",
                                  text_font=None,
        ...
        self.button_4 = SMLButton(master=self,
                                  bg_color=None,
                                  border_color="#BB8FCE",
                                  fg_color="#6C3483",
                                  hover_color="#A569BD",
        ...
        self.button_5 = SMLButton(master=self,
                                  bg_color=None,
                                  fg_color="#A93226",
                                  hover_color="#CD6155",
                                  text_font=None,
        ...
        self.button_6 = SMLButton(master=self,
                                  bg_color=None,
        ...
        play_image = ImageTk.PhotoImage(Image.open(
            "test/documentation/button_test_images/play_button_image.png").resize((30, 30)))

        self.button_7 = SMLButton(master=self,
                                  bg_color=None,
                                  fg_color="#58636F",
                                  border_color=None,
                                  hover_color="#808B96",
                                  # <- add image (class PhotoImage)
                                  image=play_image,
                                  corner_radius=10,
                                  border_width=0,
                                  width=50,
        ...
        self.button_8 = SMLButton(master=self,
                                  bg_color=None,
                                  fg_color="#212F3D",
                                  border_color="#117A65",
                                  hover_color="#34495E",
